...
cc -std=c11 -Wall -Wextra -pedantic -D_GNU_SOURCE -fsanitize=address,undefined src/network.c src/search.c tests/test_units.c src/proof_exp.c -o /tmp/test_units_asan && /tmp/test_units_asan
echo "== strict proof =="
make test
